...
Revision ID: a54230e47026
Revises: 
Create Date: 2024-05-28 15:16:28.512600
...
def upgrade():
    ...
    sa.Column('url_imagen_tienda', sa.String(length=800), nullable=False),
    ...
    sa.Column('url_imagen_producto', sa.String(length=800), nullable=False),
    sa.Column('vendedor_id', sa.Integer(), nullable=True),
    sa.Column('tienda_id', sa.Integer(), nullable=True),
    sa.Column('particular_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['particular_id'], ['particular.id'], ),
