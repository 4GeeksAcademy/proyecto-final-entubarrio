    ...
    def fill_db_with_example_data():
        ...
        try:
            ...
            productos = [
                ...
                Producto(nombre_producto="Miel", descripcion_producto="Miel de Espliego", precio="9", categoria_producto="Miel", url_imagen_producto="https://upload.wikimedia.org/wikipedia/commons/5/54/Pementos_de_Padron.jpg", vendedor_id=vendedores[0].id, tienda_id=tiendas[0].id),
                Producto(nombre_producto="Miel", descripcion_producto="Miel de Espliego", precio="10", categoria_producto="Miel", url_imagen_producto="https://upload.wikimedia.org/wikipedia/commons/5/54/Pementos_de_Padron.jpg", vendedor_id=vendedores[1].id, tienda_id=tiendas[1].id),
                Producto(nombre_producto="Miel", descripcion_producto="Miel de Espliego", precio="11", categoria_producto="Miel", url_imagen_producto="https://upload.wikimedia.org/wikipedia/commons/5/54/Pementos_de_Padron.jpg", vendedor_id=vendedores[2].id, tienda_id=tiendas[2].id),
            ]
